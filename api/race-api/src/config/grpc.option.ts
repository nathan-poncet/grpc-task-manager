...
import { CAR_PACKAGE_NAME } from 'src/stubs/car/message';
...
export const carGrpcOptions = (cs: ConfigService): ClientProviderOptions => ({
  name: CAR_PACKAGE_NAME,
  transport: Transport.GRPC,
  options: {
    url: cs.get('CAR_API_URL'),
